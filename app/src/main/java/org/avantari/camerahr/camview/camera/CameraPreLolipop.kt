package org.avantari.camerahr.camview.camera
...
class CameraPreLolipop : CameraSupport() {
    ...
    override fun setFlash(flashMode: Int): Boolean {
        ...
        if (flashMode == 1 && supportedFlashModes?.get(2) == Camera.Parameters.ANTIBANDING_50HZ) {
            parameters?.flashMode = Camera.Parameters.ANTIBANDING_50HZ
